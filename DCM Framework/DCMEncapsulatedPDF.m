...
+ (DCMObject*) encapsulatedPDF:(NSData *)pdf
{
	...
	[dcmObject setAttributeValues:[NSMutableArray arrayWithObject:@"opendicom"] forName:@"Manufacturer"];
	
	
	[dcmObject setAttributeValues:[NSMutableArray arrayWithObject:@"DOC"] forName:@"Modality"];
	[dcmObject setAttributeValues:[NSMutableArray arrayWithObject:@"-64"] forName:@"SeriesNumber"];
	[dcmObject setAttributeValues:[NSMutableArray arrayWithObject:@"informe PDF"] forName:@"SeriesDescription"];
   ...
   //JF in order to be able to read it as a simple pdf
